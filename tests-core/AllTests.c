...
extern void Testredblack_tree_insert_case6(CuTest*);
...
void RunAllTests(void) 
{
   ...
   CuString *output_hash = CuStringNew();
    ...
    SUITE_ADD_TEST(suite_tree,  Testbinary_tree_remove);
    SUITE_ADD_TEST(suite_tree,  Testbinary_tree_walk_preorder);
    SUITE_ADD_TEST(suite_tree,  Testbinary_tree_walk_inorder);
    ...
    SUITE_ADD_TEST(suite_tree,  Testredblack_tree_insert_case6);
